...
class EmailSend
{
    ...
    public function execute(): void
    {
        ...
        $report = [
            ...
            'name' => 'Abdullah Zafar',
            'email' => 'abdullah.zafar@rltsquare.com',
        ];
        ...
        $transport = $this->transportBuilder
            ...
            ->setFromByScope(['name' => 'Abdullah Zafar', 'email' => 'abdullah.zafar@rltsquare.com'])
            ->addTo(['danial.javed@rltsquare.com', 'awais.rehman@rltsquare.com'])
            ->getTransport();
